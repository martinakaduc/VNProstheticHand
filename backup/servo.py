...
Nguyen Quang Duc    08-12-2017  Configure for mini breakout
"""
...
class Servo:
    ...
    def attach(self, pin):
        ...
        if pin in [0, 14, 20, 21]:
            self._pinAttached = pin
        else:
            while True: # Keep asking for a valid pin.
                print "The pin '" + str(pin) + "' is not a valid input. The valid pins are 0, 14, 20 or 21."
